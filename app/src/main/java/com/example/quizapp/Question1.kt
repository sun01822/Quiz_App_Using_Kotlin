    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submit.setOnClickListener {
            ...
            if (checker == 2) {
                ...
                rb2.setBackgroundResource(R.drawable.correct_answer)
                if(checker==1){
                    rb1.setBackgroundResource(R.drawable.wrong_answer)
                    rb1.setTextColor(Color.WHITE)
                    rb3.setBackgroundResource(R.drawable.default_radio_button)
                    rb4.setBackgroundResource(R.drawable.default_radio_button)
                }
                else if(checker==3){
                    rb1.setBackgroundResource(R.drawable.default_radio_button)
